...
const DigitalAgency = () => {
  return (
    <>
      <SEO title='Cybersecurity Consultants' />
      <ColorSwitcher />
        ...
        <div className='section section-padding-2 bg-color-dark'>
          <div className='container'>
            <SectionTitle
              ...
              description='We provide top-notch Cybersecurity and Data Protection services for small-medium businesses on an affordable price.'
